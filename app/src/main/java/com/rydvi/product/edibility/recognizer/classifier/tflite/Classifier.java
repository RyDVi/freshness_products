...
public abstract class Classifier {
    ...
    public static ClassifierProducts createProductsClassifier(Activity activity) throws IOException {
        return new ClassifierProducts(activity, Device.CPU, 1);
    }
    ...
    protected void _classifierConstructor(Activity activity, Device device, int numThreads) throws IOException{
